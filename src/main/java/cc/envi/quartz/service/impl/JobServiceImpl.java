...
import cc.envi.quartz.mapper.JobMapper;
...
public class JobServiceImpl extends ServiceImpl<JobMapper, Job> implements IJobService {
    ...
    public void init() {
        ...
        log.info("=======初始化任务信息列表======="+scheduleJobList);
        // 如果不存在，则创建
    ...
    public void createJob(Job job) {
        ...
        job.setStatus(SystemConstant.ScheduleStatus.PAUSE.getValue());
        this.save(job);
    ...
    public void pause(String jobIds) {
        ...
        this.updateBatch(jobIds, SystemConstant.ScheduleStatus.PAUSE.getValue());
    }
    ...
    public void resume(String jobIds) {
        ...
        this.updateBatch(jobIds, SystemConstant.ScheduleStatus.NORMAL.getValue());
    }
}
