...
import cc.envi.quartz.service.IJobLogService;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        ...
        try {
            ...
            // 任务状态 0：成功 1：失败
            jobLog.setStatus(SystemConstant.JobStatus.SUCCESS.getValue());
            ...
            jobLog.setTimes(times);
            // 任务状态 0：成功 1：失败
            jobLog.setStatus(SystemConstant.JobStatus.ERROR.getValue());
